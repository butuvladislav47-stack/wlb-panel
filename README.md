...
Повторная установка сохраняет пароль панели, cookies и созданные ссылки.
Установщик останавливает старые процессы, обновляет программу и запускает
сохранённые ссылки заново.
...
Созданные ссылки работают, пока на сервере запущены соответствующие процессы.
Панель автоматически восстанавливает их после падения процесса, перезапуска
панели или повторной установки.
